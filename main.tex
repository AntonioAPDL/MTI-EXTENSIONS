...
\hypersetup{
  ...
  citecolor=black,
  urlcolor=black,
  pdftitle={Mean-Tilted Intervals: Regression and Dynamic Models},
...
zero-tilt case, deterministic fixed-feature readouts, and dynamic linear
...
dynamic settings; tolerance certification and response prediction require
