...
root-label summaries, basis-expansion endpoint models, dynamic endpoint-state
...
\section{Deterministic Basis Expansions}
...
\section{Diagnostics and Validation Limits}
