...
\hypersetup{
  ...
  citecolor=black,
  urlcolor=black,
  pdftitle={Supplementary Material: Mean-Tilted Interval Regression and Dynamic Endpoint Models},
...
\title{Supplementary Material for \emph{Mean-Tilted Interval Regression
